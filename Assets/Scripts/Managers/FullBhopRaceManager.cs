...
public class FullBhopRaceManager : MonoBehaviour
{
    ...
    public void endAttempt()
    {
        ...
        currentJumpAttempt = new JumpAttempt(scenario,attemptNumber, strafeTimingOffset, raceTimer, 0, 0, zAxisSpeedTracker.calculateAttemptSpeed(), score, 0, lookOffset, bhopAccuracy, date: System.DateTime.Now);
        if(isRace)
        {
    ...
    void Update()
    {
        ...
        if(playerStart == true)
        {
            ...
            {
                switchTrackEnd = mouseAngleTracker.currentAngle;
